...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Coba</b> (Owner)</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Login sebagai Owner</p>
...
<!-- jQuery 3 -->
<script src="<?= base_url('assets/vendor/adminlte/'); ?>bower_components/jquery/dist/jquery.min.js"></script>
<!-- Bootstrap 3.3.7 -->
<script src="<?= base_url('assets/vendor/adminlte/'); ?>bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
<!-- iCheck -->
<script src="<?= base_url('assets/vendor/adminlte/'); ?>plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
