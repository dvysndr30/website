...
<form action="" method="post" enctype="multipart/form-data">
	...
	<label>Gambar</label>
		<div>
        	<img width="100px" height="100px"  class="img-fluid" src="<?= base_url('assets/images/uploaded/user/').$user['gambar']; ?>" alt="">
    	</div>
	<input type="file" name="gambar" class="img-fluid" value="<?= $user['gambar']; ?>">
